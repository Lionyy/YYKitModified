...
#define MAX_QUEUE_COUNT 16
    ...
    atomic_ulong cur = atomic_fetch_add_explicit(&counter, 1, memory_order_relaxed);
...
@property (atomic, readonly) unsigned long value;
/// Increase the value atomically. @return The new value.
- (atomic_ulong)increase;
@end
...
- (void)_displayAsync:(BOOL)async {
    ...
    if (async) {
        ...
        unsigned long value = sentinel.value;
